...
const FeatureCard = ({
  ...
  <div className="p-6 bg-muted/10 backdrop-blur-sm rounded-xl border border-primary/10 hover:border-primary/20 hover:transform hover:scale-105 transition-all duration-300">
